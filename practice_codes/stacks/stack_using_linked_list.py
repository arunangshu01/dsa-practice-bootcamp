...
if __name__ == "__main__":
    try:
        ...
        print(stack_using_linked_list.push_element(value=10))
        print(stack_using_linked_list.push_element(value=20))
        print(stack_using_linked_list.push_element(value=30))
        print(stack_using_linked_list.push_element(value=40))
        print(stack_using_linked_list.push_element(value=50))
        print(stack_using_linked_list.push_element(value=60))
        print(stack_using_linked_list.push_element(value=70))
        print(stack_using_linked_list.push_element(value=80))
        print(stack_using_linked_list.push_element(value=90))
        print(stack_using_linked_list.push_element(value=100))
